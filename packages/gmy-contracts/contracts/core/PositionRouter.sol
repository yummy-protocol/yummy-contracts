...
contract PositionRouter is BasePositionManager, IPositionRouter, IExecutionFee {
    ...
    function setMinExecutionFee(uint256 _minExecutionFee) override external onlyAdmin {
        minExecutionFee = _minExecutionFee;
    ...
    function _callRequestCallback(
        ...
        bool success;
        try IPositionRouterCallbackReceiver(_callbackTarget).gmyPositionCallback{ gas: _gasLimit }(_key, _wasExecuted, _isIncrease) {
            success = true;
        } catch {}
