...
/**
 * @notice implementation of the GmyGovernance token contract
 * @author Gmy
 * Inspired from AAVE v2
 */
contract BFG is Initializable, GovernancePowerDelegationERC20 {
    uint8 constant VERSION = 1;
    uint256 public constant MAX_SUPPLY = 3_000 ether;
    ...
    function initialize() external initializer {
        __ERC20_init("GMY Governance Token", "BFG");
